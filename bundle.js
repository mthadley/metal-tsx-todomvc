...
var _async = __webpack_require__(55);

var _async2 = _interopRequireDefault(_async);

var _Disposable = __webpack_require__(57);
...
var _string = __webpack_require__(59);
...
var _metalComponent = __webpack_require__(3);
...
var _JSXDataManager = __webpack_require__(50);

var _JSXDataManager2 = _interopRequireDefault(_JSXDataManager);

var _JSXRenderer = __webpack_require__(24);
...
var _ComponentDataManager = __webpack_require__(13);

var _ComponentDataManager2 = _interopRequireDefault(_ComponentDataManager);

var _ComponentRegistry = __webpack_require__(36);

var _ComponentRegistry2 = _interopRequireDefault(_ComponentRegistry);

var _ComponentRenderer = __webpack_require__(14);
...
var _EventHandle = __webpack_require__(18);
...
var _domData = __webpack_require__(7);

var _domData2 = _interopRequireDefault(_domData);

var _DomEventEmitterProxy = __webpack_require__(39);
...
var _globalEval = __webpack_require__(42);

var _globalEval2 = _interopRequireDefault(_globalEval);

var _globalEvalStyles = __webpack_require__(43);
...
var _patch2 = __webpack_require__(49);
...
var Filter = exports.Filter = undefined;
(function (Filter) {
...
var _intercept = __webpack_require__(9);
...
var _unused = __webpack_require__(47);
...
var filters = [_Types.Filter.All, _Types.Filter.Active, _Types.Filter.Completed];
...
var App = function (_Component) {
    ...
    function App() {
        ...
        _this._handleClear = function () {
            _this.state.todos = _this.state.todos.filter(function (todo) {
                return !todo.done;
            });
        };
        _this._handleCreate = function (todo) {
            _this.state.todos = [todo].concat(_toConsumableArray(_this.state.todos));
        };
        _this._handleDelete = function (id) {
            _this.state.todos = _this.state.todos.filter(function (todo) {
                return todo.id !== id;
            });
        };
        _this._handleTodoChange = function (newTodo) {
            _this.state.todos = _this.state.todos.map(function (todo) {
                return todo.id === newTodo.id ? newTodo : todo;
            });
        };
        _this._handleToggleAll = function () {
            var done = !_this._allDone();
            _this.state.todos = _this.state.todos.map(function (todo) {
                return Object.assign({}, todo, { done: done });
            });
        };
        _this._handleFilterChange = function (filter) {
            _this.state.selectedFilter = filter;
        };
        return _this;
    }
    ...
    _createClass(App, [{
        ...
        key: '_countLeft',
        value: function _countLeft() {
            return this.state.todos.reduce(function (count, todo) {
                return count + (todo.done ? 0 : 1);
            }, 0);
        }
    }, {
        key: '_getFilterFn',
        value: function _getFilterFn() {
            switch (this.state.selectedFilter) {
                case _Types.Filter.Active:
                    return function (todo) {
                        return !todo.done;
                    };
                case _Types.Filter.All:
                    return function () {
                        return true;
                    };
                case _Types.Filter.Completed:
                    return function (todo) {
                        return todo.done;
                    };
            }
        ...
        value: function render() {
            ...
            IncrementalDOM.elementOpen('section', null, null, 'class', 'todoapp');
            ...
            iDOMHelpers.renderArbitrary(this._getTodos().map(function (todo) {
                return iDOMHelpers.jsxWrapper(function (_todo$id, _this2$_handleDelete, _this2$_handleTodoCha, _todo) {
                    return IncrementalDOM.elementVoid(_TodoItem2.default, _todo$id, ['key', _todo$id], 'onDelete', _this2$_handleDelete, 'onTodoChange', _this2$_handleTodoCha, 'todo', _todo);
                }, [todo.id, _this2._handleDelete, _this2._handleTodoChange, todo]);
            }));
...
var Create = function (_Component) {
    ...
    function Create() {
        ...
        var _this = _possibleConstructorReturn(this, (Create.__proto__ || Object.getPrototypeOf(Create)).apply(this, arguments));

        _this._handleInput = function (event) {
            _this.state.content = event.target.value;
        };
        _this._handleKeyPress = function (event) {
            if (event.charCode === 13 && _this.state.content.length > 0) {
    ...
    _createClass(Create, [{
        key: 'render',
        value: function render() {
            return IncrementalDOM.elementVoid('input', null, null, 'onInput', this._handleInput, 'onKeyPress', this._handleKeyPress, 'value', this.state.content, 'autofocus', true, 'class', 'new-todo', 'placeholder', 'What needs to be done?');
        }
    }]);
...
var Footer = function (_Component) {
    ...
    _createClass(Footer, [{
        ...
        value: function render() {
            ...
            IncrementalDOM.elementOpen('span', null, null, 'class', 'todo-count');
            IncrementalDOM.elementOpen('strong');
            iDOMHelpers.renderArbitrary(this.props.todoCount);
            IncrementalDOM.elementClose('strong');
            IncrementalDOM.text(' items left');
            IncrementalDOM.elementClose('span');
            IncrementalDOM.elementOpen('ul', null, null, 'class', 'filters');
            iDOMHelpers.renderArbitrary(this.props.filters.map(function (filter) {
                var label = getFilterLabel(filter);
                return iDOMHelpers.jsxWrapper(function (_ref, _ref2, _label, _ref3, _label2) {
                    IncrementalDOM.elementOpen('li');
                    IncrementalDOM.elementOpen('a', _label, ['key', _label], 'class', _ref, 'href', _ref2, 'onClick', _ref3);
                    iDOMHelpers.renderArbitrary(_label2);
                    IncrementalDOM.elementClose('a');
                    return IncrementalDOM.elementClose('li');
                }, [filter === _this2.props.selectedFilter ? 'selected' : '', '#' + label, label, function () {
                    return _this2.props.onFilterChange(filter);
                }, label]);
            }));
            IncrementalDOM.elementClose('ul');
            iDOMHelpers.renderArbitrary(this.props.showClearButton && (IncrementalDOM.elementOpen('button', null, null, 'onClick', this.props.onClear, 'class', 'clear-completed'), IncrementalDOM.text('Clear Completed'), IncrementalDOM.elementClose('button')));
...
var TodoItem = function (_Component) {
    ...
    function TodoItem() {
        ...
        var _this = _possibleConstructorReturn(this, (TodoItem.__proto__ || Object.getPrototypeOf(TodoItem)).apply(this, arguments));

        _this._handleDelete = function () {
            _this.props.onDelete(_this.props.todo.id);
        };
        _this._handleInput = function (event) {
            _this.state.content = event.target.value;
        };
        _this._handleKeyPress = function (event) {
            if (event.charCode === 13) {
                ...
                _this.props.onTodoChange(Object.assign({}, _this.props.todo, { content: _this.state.content }));
            }
        };
        _this._handleDoneChange = function () {
            var todo = _this.props.todo;

            _this.props.onTodoChange(Object.assign({}, todo, { done: !todo.done }));
        };
        _this._handleEdit = function () {
            _this.setState({
                content: _this.props.todo.content,
                editing: true
            });
        };
        return _this;
    ...
    _createClass(TodoItem, [{
        ...
        value: function render() {
            ...
            IncrementalDOM.elementOpen('li', null, null, 'class', classes);
            IncrementalDOM.elementOpen('div', null, null, 'class', 'view');
            IncrementalDOM.elementVoid('input', null, null, 'checked', todo.done, 'onChange', this._handleDoneChange, 'class', 'toggle', 'type', 'checkbox');
            IncrementalDOM.elementOpen('label', null, null, 'onDblclick', this._handleEdit);
            iDOMHelpers.renderArbitrary(todo.content);
            IncrementalDOM.elementClose('label');
            IncrementalDOM.elementVoid('button', null, null, 'onClick', this._handleDelete, 'class', 'destroy');
            IncrementalDOM.elementClose('div');
            IncrementalDOM.elementVoid('input', null, null, 'onInput', this._handleInput, 'onKeyPress', this._handleKeyPress, 'value', this.state.content, 'class', 'edit');
            return IncrementalDOM.elementClose('li');
        }
    }]);
...
_metalJsx2.default.render(_App2.default, {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(11), __webpack_require__(60)))
